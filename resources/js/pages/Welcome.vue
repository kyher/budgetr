...
<template>
    ...
    <div
        class="items-centerp-6 flex min-h-screen flex-col bg-gradient-to-bl from-[#ffe4e6] to-[#ccfbf1] lg:justify-center lg:p-8"
    >
        <header
        ...
        >
            ...
            >
                ...
                <h2 class="text-lg">
                    Login or register to manage your budgets
                </h2>
            </main>
        </div>
